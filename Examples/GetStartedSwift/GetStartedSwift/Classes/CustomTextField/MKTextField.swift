...
open class MKTextField : UITextField, UITextFieldDelegate  {
    ...
    @IBInspectable open var floatingLabelTextColor: UIColor = UIColor.black {
        didSet {
    ...
    @IBInspectable open var bottomBorderColor: UIColor = UIColor(red: 0.902, green: 0.902, blue: 0.902, alpha: 1.0) {
        didSet {
            if bottomBorderEnabled {
    ...
    fileprivate var cellSection:Int!
    fileprivate var cellRow:Int!
    ...
    override open func layoutSubviews() {
        ...
        if let text = text , text.isEmpty == false {
            ...
            let colorString:String! = "#E42603"
            floatingLabel.textColor = isFirstResponder ? colorString.hexStringToUIColor() : floatingLabelTextColor//tintColor : floatingLabelTextColor//
...
//        print(floatingLabel.frame.size.width)
//        print(textRect.size.width/2 - floatingLabel.frame.size.width/2)
